...
STAGES_ALL="preflight,up,schema,restart,contract,mfa,mail,groupsio,mqttloss,fuzz,concurrency,journeys,health,devices,browser,audit,evidence,logs,down"
STAGES_DEFAULT="preflight,up,schema,restart,contract,mfa,mail,groupsio,mqttloss,fuzz,concurrency,journeys,health,devices,browser,audit,evidence,logs,down"
