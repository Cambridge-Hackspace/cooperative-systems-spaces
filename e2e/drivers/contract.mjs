...
main(async () => {
  ...
  // A removal that removed nothing has to say so. (The tool-trainer route this
  // originally covered has been retired; the same 404-not-200 discipline is
  // asserted on the training-prerequisite route below, found by a later fuzz
  // seed.)
  //
