-- Drop webhook system tables.
DROP TABLE IF EXISTS webhook_deliveries;
DROP TABLE IF EXISTS webhook_auth_links;
DROP TABLE IF EXISTS webhook_event_subscriptions;
DROP TABLE IF EXISTS webhooks;
DROP TABLE IF EXISTS webhook_auth_headers;

-- Restore the audit_logs CHECK constraint without webhook management events.
