-- Add training-related audit event types to the audit_logs table
...
-- Add index specifically for training-related audit events
CREATE INDEX idx_audit_logs_training_events ON audit_logs (event_type, created_at DESC) 
WHERE event_type IN (
    'training_session_started', 'training_session_completed',
    'training_step_created', 'training_step_updated', 'training_step_deleted',
    'trainer_assigned', 'trainer_removed',
