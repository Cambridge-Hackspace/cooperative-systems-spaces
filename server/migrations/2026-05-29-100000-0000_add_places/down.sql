-- Roll back the places hierarchy.
ALTER TABLE space_devices DROP COLUMN IF EXISTS place_id;
ALTER TABLE tools         DROP COLUMN IF EXISTS place_id;
ALTER TABLE doors         DROP COLUMN IF EXISTS place_id_to;
ALTER TABLE doors         DROP COLUMN IF EXISTS place_id_from;
