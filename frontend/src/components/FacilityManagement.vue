<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <KeepAlive>
      ...
      <ToolWiringManagement v-else-if="tab === 'wiring'" embedded />
...
import ToolWiringManagement from './ToolWiringManagement.vue'
...
type Tab = 'places' | 'doors' | 'schedules' | 'power' | 'wiring' | 'graph'
